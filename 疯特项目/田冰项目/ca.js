(function() {
    var h = {}, mt = {}, c = {
        id: "0f15deaf9e78bb18a22b4e194330ba6f",
        dm: ["srm.quhuhu.com"],
    ...
    (function() {
        ...
        var d = mt.lang, f = mt.l, g = mt.f, n = h.D, l = h.G, p = h.ha, e = {
            s: [], B: 0, Y: u, o: {T: "", page: ""}, init: function() {
                ...
                if (a = {webim: 1, tel: 2, map: 3, sms: 4, callback: 5, share: 6}[a[1]]) e.e |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.k()
    ...
    (function() {
        ...
        var b = mt.url, d = mt.aa, f = mt.S, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage, e = mt.sessionStorage, k = h.D, w = h.G;
        a.prototype = {
            N: function(a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
            ...
            La: function() {
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(k.ea), f = b.i(a, "jn"),
                ...
                var b = e.get("Hm_unsent_" + c.id) || "", d = this.a.u ? "" : "&u=" + encodeURIComponent(document.location.href),
